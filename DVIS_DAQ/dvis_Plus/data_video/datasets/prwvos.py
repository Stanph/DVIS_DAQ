# Interface for accessing the PRW dataset.

# The following API functions are defined:
#  PRWVOS       - PRWVOS api class that loads PRW annotation file and prepare data structures.
...
class PRWVOS:
    ...
    def createIndex(self):
        ...
        #         vidToAnns[ann['image_id']].append(ann)
        #         anns[ann['id']] = ann

        # if 'images' in self.dataset:
        #     for vid in self.dataset['images']:
        #         vids[vid['id']] = vid
        ...
        #     for ann in self.dataset['annotations']:
        #         catToVids[ann['category_id']].append(ann['image_id'])
        ...
        if 'videos' in self.dataset:
            ...
            if isinstance(videos, list):
                for idx, vid in enumerate(self.dataset['videos']):
                    vids[idx]=idx
            else:
                for vid in self.dataset['videos']:                    
                    vids[videos[vid]['id']] = videos[vid]
