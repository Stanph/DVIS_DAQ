...
#  YTVOSPERSON       - YTVOSPERSON api class that loads YouTubeVIS annotation file and prepare data structures.
    ...
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            if 'annotations' in dataset:
                dataset['annotations']=[ann for ann in dataset['annotations'] if ann['category_id'] == 1]
                person_videos_id = [ann['video_id'] for ann in dataset['annotations']]
                dataset['videos']=[video for video in dataset['videos'] if video['id'] in person_videos_id]
            
            # dataset['videos']=dataset['videos'][0:10]
